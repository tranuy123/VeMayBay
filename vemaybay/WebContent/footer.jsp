        ...
        <div class="row">
          <div class="col-sm-6 col-xl-4 mb-30">
            <div class="single-cta">
              ...
              <div class="cta-text">
                <h4>Find us</h4>
                <span>số 1 Lý Thường Kiệt , Phường 9,Quận Tân Bình,TP.HCM</span>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-xl-4 mb-30">
          ...
          <div class="col-sm-6 col-xl-4 mb-30">
            <div class="single-cta">
              ...
              <div class="cta-text">
                <h4>Mail us</h4>
                <span>ludtickets@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-4">
            <div class="footer-widget">
              <div class="footer-logo">
                <i class="fa-solid fa-paper-plane"><p>LUD Airline</p></i>
              </div>
